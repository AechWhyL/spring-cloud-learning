...
public class CartServiceImpl extends ServiceImpl<CartMapper, Cart> implements ICartService {
    ...
    @Override
    @SentinelResource("queryMyCarts")
    public List<CartVO> queryMyCarts() {
        // 1.查询我的购物车列表
        System.out.println("queryMyCarts: " + UserContext.getUser());
...
//        ServiceInstance theChosenOne = serviceInstances.get(RandomUtil.randomInt(serviceInstances.size()));
//        ResponseEntity<List<ItemDTO>> response = restTemplate.exchange(
//                theChosenOne.getUri() + "/items?ids={ids}",
//                HttpMethod.GET,
//                null,
